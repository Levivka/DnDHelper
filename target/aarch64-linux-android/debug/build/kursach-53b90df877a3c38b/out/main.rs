# [allow (non_snake_case)] # [allow (non_camel_case_types)] # [allow (clippy :: style)] # [allow (clippy :: complexity)] # [allow (unused_braces , unused_parens)] # [allow (clippy :: erasing_op)] # [allow (clippy :: approx_constant)] # [allow (clippy :: eq_op)] # [allow (clippy :: cmp_owned)] # [allow (clippy :: redundant_clone)] # [allow (clippy :: overly_complex_bool_expr)] mod slint_generatedMainWindow {
     ...
     impl InnerMainWindow {
         pub fn init (self_rc : sp :: VRcMapped < sp :: ItemTreeVTable , Self > , root : & sp :: VRc < sp :: ItemTreeVTable , InnerMainWindow > , tree_index : u32 , tree_index_of_first_child : u32) {
             ...
             . apply_pin (x)) , & _self . root . get () . unwrap () . upgrade () . unwrap () , tree_index_of_first_child + 61u32 - 1 , tree_index_of_first_child + 63u32 - 1) ;
             InnertextBox_root_67 :: init (sp :: VRcMapped :: map (self_rc . clone () , | x | {
                 * & Self :: FIELD_OFFSETS . r#textbox_59 }
             . apply_pin (x)) , & _self . root . get () . unwrap () . upgrade () . unwrap () , tree_index_of_first_child + 62u32 - 1 , tree_index_of_first_child + 63u32 - 1) ;
             {
                 slint :: private_unstable_api :: set_property_binding (({
                 ...
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_noteButtonLT_51_layoutinfo_h }
                     ...
                     (sp :: r#box_layout_info_ortho (sp :: Slice :: from_slice (& [{
                         ...
                         let mut the_struct = sp :: Padding :: default () ;
                         the_struct . r#begin = ((400f64 as f64) * (0.85f64 as f64)) as _ ;
                         the_struct . r#end = 0f64 as _ ;
                         the_struct }
                     as _)) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_textbox_58_min_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((sp :: Item :: layout_info (({
                         InnerMainWindow :: FIELD_OFFSETS . r#textbox_58 }
                     + {
                         * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
                    ) . apply_pin (_self) , sp :: Orientation :: Vertical , (& _self . root . get () . unwrap () . upgrade () . unwrap () . window_adapter_impl ()))) . r#min as sp :: Coord)) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_textbox_58_min_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((sp :: Item :: layout_info (({
                         InnerMainWindow :: FIELD_OFFSETS . r#textbox_58 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_textbox_58_preferred_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((sp :: Item :: layout_info (({
                         InnerMainWindow :: FIELD_OFFSETS . r#textbox_58 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_textbox_58_preferred_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((sp :: Item :: layout_info (({
                         InnerMainWindow :: FIELD_OFFSETS . r#textbox_58 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_textbox_59_min_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((sp :: Item :: layout_info (({
                         InnerMainWindow :: FIELD_OFFSETS . r#textbox_59 }
                     + {
                         * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
                    ) . apply_pin (_self) , sp :: Orientation :: Vertical , (& _self . root . get () . unwrap () . upgrade () . unwrap () . window_adapter_impl ()))) . r#min as sp :: Coord)) as _ }
                ) ;
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_textbox_59_min_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((sp :: Item :: layout_info (({
                         InnerMainWindow :: FIELD_OFFSETS . r#textbox_59 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_textbox_59_preferred_height }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((sp :: Item :: layout_info (({
                         InnerMainWindow :: FIELD_OFFSETS . r#textbox_59 }
             ...
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_textbox_59_preferred_width }
                ) . apply_pin (_self) , & self_rc , move | self_rc | {
                     let _self = self_rc . as_pin_ref () ;
                     (sp :: LogicalLength :: new ((sp :: Item :: layout_info (({
                         InnerMainWindow :: FIELD_OFFSETS . r#textbox_59 }
             ...
             + {
                 * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
             + sp :: r#Text :: FIELD_OFFSETS . r#text) . apply_pin (_self) . set ({
                 (sp :: SharedString :: from ("Dwa")) as sp :: SharedString }
            ) ;
             {
                 slint :: private_unstable_api :: set_property_binding (({
                     InnerMainWindow :: FIELD_OFFSETS . r#textbox_58 }
         ...
         fn item_geometry (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: LogicalRect {
             ...
             let (h , w , x , y) = match index {
                 ...
                 + {
                     ...
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_notesLT_49_layout_cache }
                ) . apply_pin (_self) . get () [4usize] as sp :: Coord ,) , 56u32 => (((400f64 as f64) * (0.1f64 as f64)) as sp :: Coord , ((400f64 as f64) * (0.1f64 as f64)) as sp :: Coord , ((400f64 as f64) * (0.85f64 as f64)) as sp :: Coord , ({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#root_1_noteButtonLT_51_layout_cache }
                 ...
                 + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_x) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                     * & InnerMainWindow :: FIELD_OFFSETS . r#flickable_56 }
                 + sp :: r#Flickable :: FIELD_OFFSETS . r#viewport_y) . apply_pin (_self) . get () . get () as sp :: Coord ,) , 61u32 => (({
                     InnerMainWindow :: FIELD_OFFSETS . r#textbox_58 }
                 + {
                     * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
                 + sp :: r#Text :: FIELD_OFFSETS . r#height) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                 ...
                 + {
                     * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
                 + sp :: r#Text :: FIELD_OFFSETS . r#width) . apply_pin (_self) . get () . get () as sp :: Coord , 1f64 as sp :: Coord , 1f64 as sp :: Coord ,) , 62u32 => (({
                     InnerMainWindow :: FIELD_OFFSETS . r#textbox_59 }
                 + {
                     * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
                 + sp :: r#Text :: FIELD_OFFSETS . r#height) . apply_pin (_self) . get () . get () as sp :: Coord , ({
                 ...
                 + {
                     * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
                 + sp :: r#Text :: FIELD_OFFSETS . r#width) . apply_pin (_self) . get () . get () as sp :: Coord , 100f64 as sp :: Coord , 500f64 as sp :: Coord ,) , 9u32 ..= 12u32 => return {
                     * & Self :: FIELD_OFFSETS . r#username_5 }
         ...
         fn accessible_role (self : :: core :: pin :: Pin < & Self > , index : u32) -> sp :: AccessibleRole {
             ...
             match index {
                 ...
                 . apply_pin (_self) . accessible_role (0) , 59u32 => {
                     * & Self :: FIELD_OFFSETS . r#textbox_55 }
                 . apply_pin (_self) . accessible_role (0) , 61u32 => {
                     * & Self :: FIELD_OFFSETS . r#textbox_58 }
                 . apply_pin (_self) . accessible_role (0) , 62u32 => {
                     * & Self :: FIELD_OFFSETS . r#textbox_59 }
         ...
         fn accessible_string_property (self : :: core :: pin :: Pin < & Self > , index : u32 , what : sp :: AccessibleStringProperty ,) -> sp :: SharedString {
             ...
             match (index , what) {
                 ...
                 + {
                     * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
                 + sp :: r#Text :: FIELD_OFFSETS . r#text) . apply_pin (_self) . get () , (61u32 , sp :: AccessibleStringProperty :: r#Label) => ({
                     InnerMainWindow :: FIELD_OFFSETS . r#textbox_58 }
                 + {
                     * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
                 + sp :: r#Text :: FIELD_OFFSETS . r#text) . apply_pin (_self) . get () , (62u32 , sp :: AccessibleStringProperty :: r#Label) => ({
                     InnerMainWindow :: FIELD_OFFSETS . r#textbox_59 }
                 + {
                     * & InnertextBox_root_67 :: FIELD_OFFSETS . r#root_67 }
                 ...
                 . apply_pin (_self) . accessible_string_property (0 , what) , (59u32 , _) => {
                     * & Self :: FIELD_OFFSETS . r#textbox_55 }
                 . apply_pin (_self) . accessible_string_property (0 , what) , (61u32 , _) => {
                     * & Self :: FIELD_OFFSETS . r#textbox_58 }
                 . apply_pin (_self) . accessible_string_property (0 , what) , (62u32 , _) => {
                     * & Self :: FIELD_OFFSETS . r#textbox_59 }
     ...
     impl InnerMainWindow {
         ...
         fn item_tree () -> & 'static [sp :: ItemTreeNode] {
             ...
             , sp :: ItemTreeNode :: Item {
                 is_accessible : false , children_count : 2u32 , children_index : 61u32 , parent_index : 55u32 , item_array_index : 60u32 , }
             , sp :: ItemTreeNode :: Item {
                 is_accessible : true , children_count : 0u32 , children_index : 63u32 , parent_index : 60u32 , item_array_index : 61u32 , }
             , sp :: ItemTreeNode :: Item {
                 is_accessible : true , children_count : 0u32 , children_index : 63u32 , parent_index : 60u32 , item_array_index : 62u32 , }
            ] ;
             & ITEM_TREE }
